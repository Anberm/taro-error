...
Rsa.prototype.RSAKeyPair = function(
  encryptionExponent,
  decryptionExponent,
  modulus,
) {
...
Rsa.prototype.encryptedString = function(key, s) {
  return encryptedString(key, s);
};
Rsa.prototype.decryptedString = function(key, s) {
  return decryptedString(key, s);
};
Rsa.prototype.setMaxDigits = function(value) {
  return setMaxDigits(value);
};
